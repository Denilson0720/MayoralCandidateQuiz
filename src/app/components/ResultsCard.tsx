...
function NewsletterSignup({ quizResultId }: NewsletterSignupProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!quizResultId) {
      setError('Unable to link email to your quiz results');
      return;
    }
    ...
    return (
      <div className="bg-green-50 border border-green-200 rounded-lg p-4 max-w-md mx-auto">
        <div className="flex items-center justify-center">
          ...
          <p className="text-green-800 font-medium">Successfully signed up for newsletter!</p>
        </div>
      </div>
    );
  }
    ...
    <form onSubmit={handleSubmit} className="max-w-md mx-auto">
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <button
          type="submit"
          disabled={isSubmitting}
          className="bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white px-6 py-3 rounded-lg font-semibold transition-colors text-base whitespace-nowrap"
        >
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-cyan-200 via-slate-50 to-red-200 py-4 md:py-8">
      <div ref={resultsRef} className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg shadow-lg p-6 md:p-8 mb-6 md:mb-8 border border-blue-200">
          <div className="text-center">
            <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-3">
              Stay Updated with Mussab's Campaign
            </h3>
            <p className="text-base md:text-lg text-gray-600 mb-6 max-w-2xl mx-auto">
              Get the latest updates on Mussab's campaign, policy positions, and community events delivered to your inbox.
            </p>
            
            <NewsletterSignup quizResultId={results.quizResultId} />
          </div>
        </div>
